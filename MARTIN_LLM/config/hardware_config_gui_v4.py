...
class HardwareConfigDialog(QDialog, FramelessWindowMixin):
    ...
    def create_main_content_view(self):
        ...
        main_layout.setContentsMargins(20, 20, 20, 20) # Reducir márgenes
        ...
        # Tarjeta de información de hardware
        ...
        # Tarjeta de opciones de configuración
        ...
        main_layout.addStretch() # Añadir espacio flexible
