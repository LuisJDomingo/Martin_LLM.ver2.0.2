...
from app.llm_providers import OllamaProvider, LlamaCppProvider
...
class ChatInterface(FadeInMixin, QMainWindow, FramelessWindowMixin):
    ...
    def redetect_hardware(self):
        ...
        try:
            ...
            if os.path.exists('hardware_config.json'):
                reply = QMessageBox.question(self, "Redetectar Hardware",
            ...
            QMessageBox.critical(self, "Error", f"Error redetectando hardware: {e}")
